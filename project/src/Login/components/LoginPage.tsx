...
import { Wheat, Users, Eye, EyeOff, AlertCircle, Loader2 } from 'lucide-react';
          ...
          <div className="flex items-center justify-center mb-8 relative z-10">
            <div className="flex items-center">
              ...
              <div className="relative mr-4">
                <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-lg">
                  <div className="relative">
                    <Wheat className="w-8 h-8 text-yellow-300" />
              ...
              <div className="text-left">
                <div className="text-red-500 text-xl font-serif italic tracking-wide">Tjenyson</div>
                <div className="text-green-700 text-3xl font-bold tracking-wider">AGRIVET</div>
                <div className="text-gray-500 text-xs font-medium tracking-widest uppercase">Agricultural Solutions</div>
              </div>
            </div>
          </div>
