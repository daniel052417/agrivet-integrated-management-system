...
import { 
  ...
  Users, FileText, Settings, Bell, Truck, Shield, MessageSquare,
  Megaphone, Gift, HelpCircle, Activity, Calendar, DollarSign,
  Archive, Warehouse, Apple, Pill, Wrench, Hammer, ChevronDown,
  ChevronRight, Menu, X
} from 'lucide-react';
